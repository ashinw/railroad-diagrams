 ...
 */
import { Options, TrackDiagram, Diagram, Sequence, Stack, AlternatingSequence, OptionalSequence, Choice, HorizontalChoice, MultipleChoice, Optional, OneOrMore, Terminal, NonTerminal, Start, End, Skip, Comment, Block } from './tracks-model.js';
import { evalScript } from './tracks-functional.js';
export class ParserManager {
    constructor(src, debug = false, elementHandler) {
